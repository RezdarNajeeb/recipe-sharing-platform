            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/books" class="<?= urlIs('/books') ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> rounded-md px-3 py-2 text-sm font-medium">Books</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
                            ...
                            <?php if (isAuth()) : ?>
                                <div class="flex gap-x-3">
                                    ...
                                    <form action="/logout" method="POST">
                                        ...
                                        <button type="submit"
                                                class="text-gray-300 bg-red-700 rounded-md px-3 py-2 text-sm font-medium hover:bg-red-500 cursor-pointer">
                                            Logout
                                        </button>
                                    </form>
                                </div>
